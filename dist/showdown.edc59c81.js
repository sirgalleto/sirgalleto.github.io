      ...
      function (require, module, exports) {
        ...
        (function () {
            ...
            for (var s = 0; s < e.length; ++s) {
              ...
              if ("object" != _typeof(i))
                return (
                  (n.valid = !1),
                  (n.error =
                    o + "must be an object, but " + _typeof(i) + " given"),
                  n
                );
          ...
          a.subParser("autoLinks", function (e, r, t) {
              ...
              return (
                ...
                (e = e.replace(n, function (e) {
                  return (
                    ...
                    (e = e.replace(/(^|\n)/g, "$1  ")),
                    (e = e.replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function (
                      e,
                      r
                    ) {
                      var t = r;
            ...
            a.subParser("escapeSpecialCharsWithinTagAttributes", function (
              e,
              r,
              t
            ) {
            ...
            a.subParser("hashHTMLSpans", function (e, r, t) {
              ...
              return (
                ...
                (e = e.replace(/<([^>]+?)\s[^>]+?>[\s\S]*?<\/\1>/g, function (
                  e
                ) {
                  return a(e);
                })),
              ...
              return (
                ...
                (e = e.replace(
                  ...
                  function (e, r, t, a, s, o, i, l) {
                    return (
                      (a = a.replace(/\s/g, "")), n(e, r, t, a, s, o, 0, l)
                    );
                  }
                )),
                (e = e.replace(
            ...
            a.subParser("stripLinkDefinitions", function (e, r, t) {
              ...
              var n = function n(e, _n2, s, o, i, l, c) {
                return (
                  (_n2 = _n2.toLowerCase()),
                  s.match(/^data:.+?\/.+?;base64,/)
                    ? (t.gUrls[_n2] = s.replace(/\s/g, ""))
                    : (t.gUrls[_n2] = a.subParser("encodeAmpsAndAngles")(
                        s,
                        r,
                        t
                      )),
            ...
            a.subParser("makeMarkdown.listItem", function (e, r) {
              ...
              for (
                var t = "", n = e.childNodes, s = n.length, o = 0;
                o < s;
                ++o
              ) {
                t += a.subParser("makeMarkdown.node")(n[o], r);
            ...
            a.subParser("makeMarkdown.node", function (e, r, t) {
              ...
              switch (e.tagName.toLowerCase()) {
                case "h1":
                  t ||
                    (n = a.subParser("makeMarkdown.header")(e, r, 1) + "\n\n");
                  break;

                case "h2":
                  t ||
                    (n = a.subParser("makeMarkdown.header")(e, r, 2) + "\n\n");
                  break;

                case "h3":
                  t ||
                    (n = a.subParser("makeMarkdown.header")(e, r, 3) + "\n\n");
                  break;

                case "h4":
                  t ||
                    (n = a.subParser("makeMarkdown.header")(e, r, 4) + "\n\n");
                  break;

                case "h5":
                  t ||
                    (n = a.subParser("makeMarkdown.header")(e, r, 5) + "\n\n");
                  break;

                case "h6":
                  t ||
                    (n = a.subParser("makeMarkdown.header")(e, r, 6) + "\n\n");
                  break;

                case "p":
                  t ||
                    (n = a.subParser("makeMarkdown.paragraph")(e, r) + "\n\n");
                  break;

                case "blockquote":
                  t ||
                    (n = a.subParser("makeMarkdown.blockquote")(e, r) + "\n\n");
                  break;
                ...
                case "ol":
                  t ||
                    (n = a.subParser("makeMarkdown.list")(e, r, "ol") + "\n\n");
                  break;

                case "ul":
                  t ||
                    (n = a.subParser("makeMarkdown.list")(e, r, "ul") + "\n\n");
                  break;

                case "precode":
                  t ||
                    (n = a.subParser("makeMarkdown.codeBlock")(e, r) + "\n\n");
                  break;
            ...
            a.subParser("makeMarkdown.table", function (e, r) {
              ...
              for (t = 0; t < i.length; ++t) {
                ...
                if (i[t].hasAttribute("style")) {
                  switch (
                    i[t].getAttribute("style").toLowerCase().replace(/\s/g, "")
                  ) {
              ...
              for (t = 0; t < o.length; ++t) {
                for (n = 0; n < o[t].length; ++n) {
                  1 === t
                    ? ":" === o[t][n].slice(-1)
                      ? (o[t][n] =
                          a.helper.padEnd(o[t][n].slice(-1), _ - 1, "-") + ":")
...
//# sourceMappingURL=/showdown.edc59c81.js.map
