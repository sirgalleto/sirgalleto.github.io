...
})(
  {
    ...
    bzA8: [
      function (require, module, exports) {
        ...
        var t = n(require("../data/projects.json"));
        function n(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function o(e, r) {
        ...
        var u = window.fetch,
          s = 4;
        function a() {
          var n = t.default.reduce(
            function (e, r, t) {
              var n = e[e.length - 1],
                o = c({ index: t }, r);
              return n.length < s ? n.push(o) : e.push([o]), e;
            },
            [[]]
          );
          (0, r.renderTemplate)("projects", "allProjects", {
            projectsSection: n,
          }),
            e.default.init({ offset: 200 });
        }
        window.onload = a;
      },
      {
...
//# sourceMappingURL=/projects.bd04911f.js.map
